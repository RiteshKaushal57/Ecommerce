    ...
    return (
        <div className='flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center py-20 text-xs sm:text-sm md:text-base text-gray-700'>
            <div className='flex flex-col items-center gap-2'>
                <img className='size-10' src={assets.exchange_icon} />
                <div className='flex flex-col items-center'>
                    <p className='text-md font-semibold'>Easy Exchane Policy</p>
                    <p className='text-sm text-gray-400'>We offer hassle free exchange policy</p>
                </div>
            </div>
            <div className='flex flex-col items-center gap-2'>
                <img className='size-10' src={assets.quality_icon} />
                <div className='flex flex-col items-center'>
            ...
            <div className='flex flex-col items-center gap-2'>
                <img className='size-10' src={assets.support_img} />
                <div className='flex flex-col items-center'>
